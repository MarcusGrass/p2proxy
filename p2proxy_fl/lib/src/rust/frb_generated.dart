...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -623320606;
...
abstract class RustLibApi extends BaseApi {
  ...
  UserDefinedKey crateApiTokensUserDefinedKeyGenerateWithName({String? name});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  UserDefinedKey crateApiTokensUserDefinedKeyGenerateWithName({String? name}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiTokensUserDefinedKeyGenerateWithNameConstMeta,
        argValues: [name],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiTokensUserDefinedKeyGenerateWithNameConstMeta =>
      const TaskConstMeta(
        debugName: "UserDefinedKey_generate_with_name",
        argNames: ["name"],
      );
