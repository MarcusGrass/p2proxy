          ...
          Padding(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                try {
                  UserDefinedKey key = UserDefinedKey.tryNew(
                    rawHex: _secretKeyHexController.text,
                    name: name,
                  );
                  setState(() {
                    _loadKeysFuture = widget.storage.storeKeys(key);
                  });
                  widget.keysDirty();
                } on Exception catch (e) {
                  errorToast(_fToast, "failed to create key $e");
                }
              },
